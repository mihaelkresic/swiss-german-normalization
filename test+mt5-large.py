...
if __name__ == "__main__":
    ...
    model = T5Model("mt5", "/content/drive/MyDrive/swiss-german-normalization/mT5-large/best_model", args=model_args)
    ...
    result_df.to_csv(output_folder + 'test_predictions_mt5-large.csv', index=False)
